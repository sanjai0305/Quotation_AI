...
export default function Register({ goToLogin }) {
  ...
  // Handle Form Submission (Handles both Step 1 & Step 2)
    ...
    // --- STEP 2: VERIFY OTP ---
      ...
      try {
        ...
        if (res.ok) {
          ...
          setTimeout(() => {
            goToLogin(); // Switch to dashboard if preferred
          }, 1500);
        } else {
          setMessage({ type: "error", text: data.message || "Invalid OTP. Please try again." });
        }
      } catch (error) {
        setMessage({ type: "error", text: "Verification failed. Please try again later." });
      } finally {
        setIsLoading(false);
      }
    }
  ...
  return (
    <div className="min-h-screen w-full flex bg-slate-50 font-sans text-gray-800 selection:bg-indigo-100 selection:text-indigo-900">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 md:px-24 xl:px-32 py-12 bg-white relative z-10 shadow-[20px_0_40px_rgba(0,0,0,0.04)] rounded-r-3xl lg:rounded-r-[40px]">
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500 text-base">
              {step === 1 
                ...
                : `We've sent a secure code to ${formData.email}.`}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {/* --- STEP 1 CONTENT: Registration Details --- */}
            {step === 1 && (
              <div className="space-y-5 animate-fade-in">
                ...
                <div className="flex items-start mt-4">
                  ...
                  <label htmlFor="terms" className="ml-3 block text-sm text-gray-600 leading-tight">
                    I agree to the <a href="#" className="text-indigo-600 hover:text-indigo-800 font-semibold hover:underline transition-colors">Terms of Service</a> and <a href="#" className="text-indigo-600 hover:text-indigo-800 font-semibold hover:underline transition-colors">Privacy Policy</a>.
                  </label>
                </div>
              </div>
            )}

            {/* --- STEP 2 CONTENT: OTP Verification --- */}
            {step === 2 && (
                ...
                <div>
                  ...
                  <div className="relative group mt-2">
                    ...
                    <input
                      ...
                      className="block w-full pl-12 pr-4 py-4 text-center text-2xl tracking-[0.5em] font-bold text-gray-800 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-200"
                    />
                  </div>
                </div>
          ...
          {/* Login Navigation (Only show in Step 1 to keep OTP screen clean) */}
          {step === 1 && (
      ...
      <div className="hidden lg:flex w-1/2 relative items-center justify-center bg-[#F8FAFC] overflow-hidden">
        ...
        <div className="absolute top-0 right-0 -mr-20 -mt-20 w-[600px] h-[600px] bg-gradient-to-b from-blue-200/50 to-indigo-200/50 rounded-full blur-3xl mix-blend-multiply opacity-70"></div>
        <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-[500px] h-[500px] bg-gradient-to-t from-purple-200/50 to-pink-200/50 rounded-full blur-3xl mix-blend-multiply opacity-70"></div>
        ...
        <div className="relative z-10 flex flex-col items-center max-w-lg px-8">
          ...
          <div className="mt-12 text-center bg-white/90 backdrop-blur-xl px-8 py-5 rounded-2xl shadow-xl border border-white/60 transform transition-all duration-300 hover:scale-105">
            <h3 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600">
              {step === 1 ? "Streamline your workflow" : "Secure your account"}
            </h3>
            <p className="text-sm text-gray-500 mt-2 font-medium">
              {step === 1 ? "Join thousands of professionals generating smart quotes instantly." : "We use enterprise-grade security to protect your data."}
            </p>
          </div>
        </div>
      </div>
